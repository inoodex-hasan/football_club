...
@section('title', 'Board Director Management')
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('admin.board_directors.create') }}" class="btn btn-primary">
                                    <i class="fas fa-plus"></i> Add New Board Director Member
                                </a>
                            </div>
                        </div>
