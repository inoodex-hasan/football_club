...
const TrainingPackage = ({ packages }) => {
    ...
    return (
      ...
      ${
          pkg.is_popular
              ? "border-4 border-blue scale-105 z-10" // Styles for Popular
              : "border border-gray-100" // Styles for Normal
      }`}
                        >
                            {/* Only show the badge if is_popular is true */}
                            {pkg.is_popular && (
                                <span className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-blue text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg">
                                    MOST POPULAR
                                </span>
                            )}
                            ...
                            <p className="text-4xl font-bold mb-6 text-blue">
            ...
            or just render the content. */}
                            ...
                            <Link
                                ...
                                className="w-full py-4 rounded-lg block text-center font-bold text-white bg-blue hover:bg-blue transition"
                            >
                                Register Package
                            </Link>
                        </div>
