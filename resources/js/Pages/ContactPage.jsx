      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            education expo or need assistance, we’re here to help.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-white flex gap-4 p-8 rounded-2xl shadow-lg border border-gray-100 hover:scale-105 transition-transform">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2" style={{ color: "#283e77" }}>Visit Us</h3>
    ...
    <p className="text-sm text-gray-500 mt-2 italic">
      Mon - Fri: 10:00 AM - 6:00 PM
            ...
            <div className="bg-white flex gap-4 p-8 rounded-2xl shadow-lg border border-gray-100 hover:scale-105 transition-transform">
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-2" style={{ color: "#283e77" }}>Email Us</h3>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.name ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.email ? 'border-red-500' : 'border-gray-300'}`}
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  className={`w-full px-5 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${errors.message ? 'border-red-500' : 'border-gray-300'}`}
