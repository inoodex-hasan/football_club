        ...
        <section className="bg-gray-200 py-16 md:py-24">
            <div className="container px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 md:mb-16">
                    <h2 className="text-4xl md:text-4xl font-noto font-bold mb-4 text-blue">
                        Our Gallery
                    </h2>
                ...
                <div className="flex justify-center gap-8">
                    <button className="custom-prev bg-blue cursor-pointer text-white hover:bg-[#1e2d5a] transition p-4 rounded-full shadow-lg disabled:opacity-50">
                        <svg
                            className="w-6 h-6"
                            fill="none"
                            stroke="currentColor"
                    ...
                    <button className="custom-next bg-blue cursor-pointer text-white hover:bg-[#1e2d5a] transition p-4 rounded-full shadow-lg disabled:opacity-50">
                        <svg
                            className="w-6 h-6"
                            fill="none"
                            stroke="currentColor"
            ...
            {selectedItem && (
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-white text-center mt-4 text-xl font-light">
