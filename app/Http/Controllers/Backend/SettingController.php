...
use App\Http\Requests\Setting\EmailConfigurationUpdateRequest;
use App\Http\Requests\Setting\GeneralSettingUpdateRequest;
use App\Http\Requests\Setting\LogoSettingUpdateRequest;
...
class SettingController extends Controller
{
    ...
    {
        $generalSetting = GeneralSetting::select('id', 'site_name',  'contact_email', 'contact_phone', 'contact_address', 'currency_name', 'currency_icon', 'time_zone','map')->first();
        $emailConfiguration = EmailConfiguration::select('id', 'email', 'host', 'username', 'password', 'port', 'encryption')->first();
        $logoSetting = LogoSetting::select('id', 'logo', 'favicon')->first();
